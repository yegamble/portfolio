    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/50 bg-slate-900/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-5xl items-center justify-between px-6 lg:px-8">
        <div className="flex items-center gap-4">
          <Link
            href="/"
            className="text-base font-bold tracking-tight text-slate-200"
          >
            Yosef Gamble
          </Link>
          <span className="hidden h-4 w-px bg-slate-700 sm:inline-block"></span>
          <span className="hidden text-xs font-medium uppercase tracking-widest text-slate-500 sm:inline-block">
