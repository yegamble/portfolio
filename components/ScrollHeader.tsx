...
export default function ScrollHeader() {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-50 w-full transition-colors duration-300 motion-reduce:duration-0 ${
          isScrolled
      ...
      >
        <div className="mx-auto flex h-16 w-full max-w-5xl items-center justify-between px-6 lg:px-8">
          ...
          <div
            className={`flex items-center gap-4 transition-all duration-300 motion-reduce:duration-0 ${
              isScrolled
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col justify-center px-6 pb-16 pt-12 md:pb-24 md:pt-20 lg:px-8">
        <div ref={sentinelRef}>
